...
//  })
	...
	public List<RoleDO> getList(@RequestParam RoleDO condition){
		//查询列表数据
...
//	})
//	public PPageUtils getListPage(@RequestParam int page, @RequestParam int size, @RequestParam RoleDO condition){
//		//查询列表数据
//		Map<String,Object> params = new HashMap<String,Object>();
