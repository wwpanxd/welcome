...
//  })
	...
	public List<StuExpendsDetailsDO> getList(@RequestParam StuExpendsDetailsDO condition){
		//查询列表数据
...
//     if(condition!=null) params.put("id",condition.getId());//业务的筛选条件
	...
	public PPageUtils getListPage(@RequestParam int page, @RequestParam int size, @RequestParam StuExpendsDetailsDO condition){
		//查询列表数据
		Map<String,Object> params = new HashMap<String,Object>();
...
//     if(condition!=null) params.put("id",condition.getId());//业务的筛选条件
	...
	@ApiOperation(value="添加XXX", notes="添加XXX"
			+ "入参StuExpendsDetails，是StuExpendsDetailsDO(XXX类)")
	@ApiResponses({
