...
//  })
	...
	public List<YXUniversityDO> getList( YXUniversityDO condition){
		//查询列表数据
...
//     if(condition!=null) params.put("id",condition.getId());//业务的筛选条件
	...
	public PPageUtils getListPage(@RequestParam int page, @RequestParam int size, YXUniversityDO condition){
		//查询列表数据
		Map<String,Object> params = new HashMap<String,Object>();
